...
function NoticeEdit() {
  ...
  const { boardDTO, isLoading, isError, error, category, setCategory, title, setTitle, imagePreview, 
          handleImageChange, selectedFiles, isSubmitting, handleSubmit } = useNoticeEditHook(postId);
